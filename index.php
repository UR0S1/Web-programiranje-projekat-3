...
<body>
    ...
    <main class="container">
        ...
        $rezultati_stranica = mysqli_query($veza, $sqlstranica);
        $ukupnoclanaka = mysqli_num_rows($rezultati_stranica);
        ...
        for ($i = 1; $i <= $ukupnostranica; $i++) {
            ?>
            <a href="?p=<?php echo $i; ?>"><button class="btn btn-info"><?php echo $i; ?></button></a>&nbsp; <?php
        }
        echo "</center>";
        ?>
    </main>
