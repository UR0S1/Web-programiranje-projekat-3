...
include_once "../ukljuci/konekcija.php"; session_start();
...
<html lang="sr">
    ...
    <body>
            ...
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom"> 
                        <h1 class="h2">уребиваже чланка</h1>
                    ...
                    <?php
                        ...
                        while ($ObrazacRed=mysqli_fetch_assoc($ObrazacRezultat)) {
                            ...
                            $clanakSadrzaj = $ObrazacRed ['clanak sadrzaj']; 
                    ...
                    ?>
                        <form method="post" enctype="multipart/form-data">
                            ...
                            Садржај чланка 
                            <textarea name="clanak_sadrzaj" class="form-control" id="exampleFormControlTextareal" rows="9"><?php echo $clanakSadrzaj ?></textarea><br> 
                            ...
                            Кључне речи
                            <input type="text" name="clanak_reci" class="form-control" placeholder="унесите клучне речи"value="<?php echo $clanakReci; ?>"><br> 
                            <button name="prihvati" type="submit" class="btn btn-primary">Ажурираже</button>
                        </form>
                        <?php } ?>
                        <?php
                                    ...
                                    if (in_array($fileExtension, $allowedExt)) {
                                        if ($fileErr === 0) {
                                            if ($fileSize< 3000000) {
                                                ...
                                                echo '<script>window.location = "clanak_dodavanje.php?porukа=Датотека jе сувише велика!"; </script>'; 
                                                exit();
                                            }
                                        }
                                        else{
                                            echo '<script>window.location = "clanak_dodavanje.php?poruka=Tpешка приликом учитаважа датотеке"; </script>'; 
                                            exit();
                                        }
                                }
                                    else{
                                        echo '<script>window.location = "clanak_dodavanje.php?poruka=Дaтoтека jе сувише велика за учитаваже!";</script>'; exit();
                                    }
                                }
                                else{
                                // Корисник не жели да ажурира и датотеку
                                $sql = "UPDATE clanak SET clanak_naslov='$clanak_naslov', clanak_reci='$clanak_reci', clanak_sadrzaj='$clanak_sadrzaj' WHERE clanak_id='$clanak_id'"; if (mysqli_query($veza, $sql)) {
                                echo '<script>window.location = "clanci.php?poruka=чланак+jе+ажуриран"; </script>';
                                }
                                else {
                                echo '<script>window.location = "clanci.php?poruka=rрeшкa"; </script>';
                                }
                            }
                        }
                        ?>
        ...
        <script src="https://cloud.tinymce.com/stable/tinymce.min.js?apikey=ey51n3e6qq2sq6u5ka28g3yxtbiyj1lzs816qyfegao3c0su"></script>
...
<?php
        ...
        header("Location: prijavljivanje.php?poruka=молимо+вас+дa+се+приjавите");
    }
?>