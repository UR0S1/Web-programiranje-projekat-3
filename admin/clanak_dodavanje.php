...
<select name="clanak_kategorija" class="form-control" id="obrazacClanak Izbor1">
<?php
...
?>
<option value="<?php echo $kategorija_id; ?>"><?php echo $kategorija_naziv; ?></option> <?php
}
?>
</select><br>
Садржај чланка
...
Кључне речи
<input type="text" name="clanak_reci" class="form-control" placeholder="унесите клучне речи"><br> <button name="prihvati" type="submit" class="btn btn-primary">Прихвати</button>
</form>
<?php
...
header ("Location: clanci.php?poruka=чланак+je+додат");
}
else{
...
header ("Location: clanak_dodavanje.php?poruka=Слика+je+сувише+велика"); 
exit();
}
}
else {
