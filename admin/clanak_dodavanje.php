...
<body>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <div id="admin-index-form">
                ...
                <form method="post" enctype="multipart/form-data">
                    Наслов чланка
                    <input type="text" name="clanak_naslov" class="form-control" placeholder="Унесите наслов чланка"><br> Категорија чланка
                    ...
                    Садржај чланка
                    <textarea name="clanak_sadrzaj" class="form-control" id="obrazacSadrzaj Textareal" rows="3"></textarea><br>
                    Слика
                    <input type="file" name="file" class="form-control-file" id="exampleFormControlFile1"><br>
                    Кључне речи
                    <input type="text" name="clanak_reci" class="form-control" placeholder="унесите кључне речи"><br> <button name="prihvati" type="submit" class="btn btn-primary">Прижвати</button>
                </form>
                <?php
                            ...
                            if ($fileErr === 0) {
                                if ($fileSize< 3000000) {
                                    ...
                                    if (mysqli_query($veza, $sql)) { 
                                        header ("Location: clanci.php?poruka=чланак+jе+додат");
                    
                                    }
                                    else{
                                        header ("Location: clanak_dodavanje.php?poruka=гpeшкa");
                                    }
                    }
                                else {
                                    header ("Location: clanak_dodavanje.php?poruka=Cликa+je+сувише+велика"); 
                                    exit();
                                }
                    }
                            else {
    ...
    <script src="https://cloud.tinymce.com/stable/tinymce.min.js?apiKey=ey51n3e6qq2 sq6u5ka28g3yxtbiyj11zs816qyfegao3c0su"></script>
