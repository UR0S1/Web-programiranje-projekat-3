        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <div id="admin-index-form">
                    ...
                    <form method="post">
                        Име:
                        <input name="autor_ime" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="VHесите име"value="<?php echo $_SESSION['autor_ime']; ?>"><br> Е-адреса:
                        ...
                        Лозинка:
                        <input name="autor_lozinka" type="password" class="form-control" id="exampleInputPassword1" placeholder="Лosинка"><br> Основне информације:
                        <textarea name="autor_info" class="form-control" id="exampleFormControlTextareal" rows="3"><?php echo $_SESSION['autor_info']; ?></textarea><br> <button type="submit" name="update" class="btn btn-primary">Ажуриране података</button>
                    </form>
                    <?php
                            ...
                            if (!filter_var ($autor_eadresa, FILTER_VALIDATE_EMAIL)) {
                                ...
                                if (empty($autor_lozinka)) {
                                    ...
                                    if (mysqli_query($veza, $sql)) {
                                        ...
                                        header ("Location: index.php?poruka=3aпис+jе+ажуриран");
                                    } else {
                                        echo "Трeшка";
                                    }
                                } else {
                                    ...
                                    if (mysqli_query($veza, $sql)) {
                                        session_unset();
                                        session_destroy();
                                        header ("Location: prijavljivanje.php?poruka=Запис+je+ажуриран+можете+поново+да+се+приjавите");
                                    } else {
                                        echo "Грешка";
                                    }
                                }
...
<?php
    ...
    header ("Location: prijavljivanje.php?poruka=молимо+вас+да+се+приjавите");
}
?>
