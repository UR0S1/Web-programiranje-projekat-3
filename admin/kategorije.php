...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom"> <!--h1 class="h2">Kaтегориje</h1-->
<button id="addCatBtn" class="btn btn-info">Додавање нове категоpиje</button>
<h6>3драво <?php echo $_SESSION['autor_ime']; ?> | Ваша улога je <?php echo $_SESSION['autor_uloga']; ?></h6> </div>
...
<input type="text" name="kategorija_naziv" class="form-control" placeholder="назив категоpиje"><br> <button name="submit" class="btn btn-success">Додaj категориjу</button> </form><br>
</div>
<h1>Kaтeгориje:</h1>
<table class="table">
<thead>
<tr>
<th scope="col">Ид категopиje</th>
