...
if (isset($_SESSION['autor_uloga'])) {
    if ($_SESSION['autor_uloga']=="admin") {
        ...
        <textarea name="stranica_sadrzaj" class="form-control" rows="3" placeholder="уHeсите садржаj странише"></textarea> <br>
        ...
        <thead>
        <tr>
        <th scope="сol">ИД странице</th>
        <th scope="сol">Наслов странице</th>
        ...
        while ($row=mysqli_fetch_assoc($rezultat)) {
            ...
            <button class="btn btn-danger">Уклањање</button> </a></td>
            </tr>
            <?php 
        } 
        ?>
