    ...
    if (!isset($_SESSION['autor_uloga'])) {
        ...
        if ($_SESSION['autor_uloga'] != "admin") {
            ...
            if (mysqli_num_rows($rezultat) <= 0) {
                header("Location: stranice.php?poruka=Страниша+ниjе+пронайена");
                exit();
            } else {
?>
<!DOCTYPE html>
        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">уреhиваже странише</h1>
                ...
                <div id="admin-index-form">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        Наслов странице
                        <input type="text" name="stranica_naslov" class="form-control" placeholder="унесите наслов странише" value="<?php echo $stranicaNaslov; ?>"><br>
                        Садржај странице
                        <textarea name="stranica_sadrzaj" class="form-control" id="exampleFormControlTextareal" rows="9"><?php echo $stranicaSadrzaj ?></textarea><br>
                        <button name="submit" type="submit" class="btn btn-primary">Аxурираже</button>
                    </form>
                    <?php
                    }
                    if (isset($_POST['submit'])) {
                        ...
                        if (mysqli_query($veza, $sql)) {
                            echo '<script>window.location = "stranice.php?poruka=Странишa+je+Ажурирана"; </script>';
                            exit();
                        } else {
                            echo '<script>window.location = "stranice.php?poruka=гpeшкa"; </script>';
                            exit();
                        }
                    }
                    ?>
