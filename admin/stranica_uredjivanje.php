    ...
    if (!isset($_SESSION['autor_uloga'])) {
        ...
        if ($_SESSION['autor_uloga']!="admin") {
            ...
            if (mysqli_num_rows($rezultat) <= 0) {
                ...
                header("Location: stranice.php?poruka=Страница+ниjе+пронађена");
                exit();
            } else {
                ?>
                <!DOCTYPE html>
                ...
                while ($ObrazacRed=mysqli_fetch_assoc($ObrazacRezultat)){
                    ...
                    <button name="submit" type="submit" class="btn btn-primary">Ажурирај</button>
                    </form> 
                    <?php 
                } 
                if (isset($_POST['submit'])) {
                    ...
                    if (mysqli_query($veza, $sql)) {
                        echo '<script>window.location = "stranice.php?poruka=Страница+je+ажурирана"; </script>';
                    } else {
