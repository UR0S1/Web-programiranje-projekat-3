...
<button class="btn btn-lg btn-primary btn-block" name="registrovanje" type="submit">Рeгистpовање</button>
</form>
</div> 
<?php
...
header("Location: registracija.php?poruka=Пољa+су+празна");
exit();
}
...
header ("Location: registracija.php?poruka=Регистрациja+ниjе+успешна"); 
exit();
}
}
}
